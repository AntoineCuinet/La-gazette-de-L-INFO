...
//               Page de rédaction (redaction.php)             \\
//                                                             \\
...
/**
 * Affichage du contenu principal de la page (purement statique)
 *
 * @return  void
 */
    ...
    echo '<main>',
        ...
        '<section>',
            ...
            '<article class="redacteur" id="akuz">',
                ...
                '<p>Sans cesse sur les théatres d\'opération aux 4 coins du monde, Alex prête régulièrement sa plume à la Gazette de L-INFO pour nous raconter les trépidentes aventures de nos étudiants de Licence en stage à l\'étranger. </p>',
                ...
                '<p>Equipé des derniers gadgets à la mode dans le domaine des technologies mobiles (très envié de nos sous-fifres <a href="#pheupakeur">Pete</a> et <a href="#yjourdelesse">Yves</a>), Alex s\'infiltre partout, et approvisionne la rédaction en images les plus époustouflantes venues du monde entier. </p>',
                '<p>Membre co-fondateur de la rédaction avec <a href="#jbigoude">Johnny</a>, le duo a su imposer la présence de cet OVNI journalistique qu\'est notre Gazette au sein du département informatique. </p>',
            '</article>',
        ...
        '<section>',
            ...
            '<article class="redacteur" id="pheupakeur">',
                ...
                '<p>Equipé de son reflex dernier cri, Pete est l\'oeil de la Gazette de L-INFO. Ses clichés originaux viennent parfaitement illustrer les articles magistrement écrits par nos collaborateurs. </p>',
            ...
            '<article class="redacteur" id="yjourdelesse">',
                ...
                '<p>Puni suite à un choix d\'illustration &#128286;, Yves passe désormais la moitié de son temps de travail au pilori, devant l\'entrée ouest du bâtiment Propédeutique.</p>',
            '</article>',
        '</section>',
        '<section>',
